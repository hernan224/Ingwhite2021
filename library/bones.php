...
function bones_scripts_and_styles() {
  ...
  if (!is_admin()) {
		...
		// Swiper slider style
		wp_register_style( 'bones-swiper-css', 'https://unpkg.com/swiper/swiper-bundle.min.css', array(), null, 'screen' );
...
;
		...
		// Swiper slider js
		wp_register_script( 'bones-swiper-js', 'https://unpkg.com/swiper/swiper-bundle.min.js', array('jquery'), '', true );

		//adding scripts file in the footer
		wp_register_script( 'bones-fn-js', get_stylesheet_directory_uri() . '/library/js/libs/functions.js', array( 'jquery' ), '', true );
		...
		if (is_home()) wp_enqueue_style( 'bones-swiper-css' );
		...
		*/ 
		...
		if (is_home())  wp_enqueue_script( 'bones-swiper-js' );
		wp_enqueue_script( 'bones-fn-js' );
...
function bones_theme_support() {
	...
	register_nav_menus(
		array(
			...
			'mobile-nav' => __( 'Mobile Navigation', 'bonestheme' ), // secondary nav in footer
